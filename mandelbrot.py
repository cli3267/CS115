...
"""
if col % 10 == 0 and row % 10 == 0: is different from if col % 10 == 0 or row % 10 == 0: because of the conditions. The 'and'
statement will need both conditions to be true in order to do the if statement. The 'or' statement will only need one of
the conditions to be true in order to do the if statement.
""" 
